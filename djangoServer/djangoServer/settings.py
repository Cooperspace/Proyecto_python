...
SECRET_KEY = 'django-insecure-n$bofcig$hl(w+5-ce+503&m3qq1%34a^c_d+fep_-e_%zlkw%'
...
# STATICFILES_DIRS = ['D:\Java_Python\proyectoPython\Proyecto_python\djangoServer\static']
